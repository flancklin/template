 ...
 */(function (e) {
    e.fn.slimtable = function (t,ii) {
        function c(t) {//是否对前端数据进行分页。
        ...
        function h() {//在表格头部加排序图标
            o.find("th").each(function (t) {
                e(this).attr("unselectable", "on");
                if (r[t] && r[t].sortable) {
                    var n = document.createElement("span");
                    e(n).addClass("slimtable-sprites"), e(n).attr("unselectable", "on"),
                        ...
                        e(this).prepend(n).css({cursor: "pointer"}).on("click", g)
                }
            })
        }

        function p() {//从界面获取数据放入s中
            var t = o.find("th");
            r = new Array;
